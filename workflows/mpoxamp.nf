...
WorkflowMpoxamp.initialise(params, log)
...
*/
    ...
    // MODULE: MultiQC
    //
    workflow_summary    = WorkflowMpoxamp.paramsSummaryMultiqc(workflow, summary_params)
    ch_workflow_summary = Channel.value(workflow_summary)

    methods_description    = WorkflowMpoxamp.methodsDescriptionText(workflow, ch_multiqc_custom_methods_description, params)
